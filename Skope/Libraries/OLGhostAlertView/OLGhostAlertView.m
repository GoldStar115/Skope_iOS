...
#define VERTICAL_PADDING 7.0           //14.0
...
- (void)setStyle:(OLGhostAlertViewStyle)style
{
    ...
    if (style == OLGhostAlertViewStyleLight) {
        ...
        backgroundColor =  [UIColor colorWithRed:36.0/255 green:28.0/255 blue:47.0/255 alpha:0.75]; //[UIColor colorWithWhite:0 alpha:.75];
