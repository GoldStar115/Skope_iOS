...
#define kAvatarImageViewMargin 15.0
...
- (CGSize)messageBubbleSizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([messageItem isMediaMessage]) {
        ...
        CGFloat horizontalInsetsTotal = horizontalContainerInsets + horizontalFrameInsets + spacingBetweenAvatarAndBubble /* + kAvatarImageViewMargin*/;
        ...
        //CGFloat maximumTextWidth = self.itemWidth - self.messageBubbleLeftRightMargin - horizontalInsetsTotal;
        //===========================
        
        CGRect stringRect = [[messageItem text] boundingRectWithSize:CGSizeMake(maximumTextWidth, CGFLOAT_MAX) options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
        ...
        //CGFloat finalWidth = maximumTextWidth + 2.0f;
        CGFloat finalWidth = MAX(stringSize.width + horizontalInsetsTotal, self.bubbleImageAssetWidth) + 2.0f;
        //finalSize = CGSizeMake(MAX(maximumTextWidth ,finalWidth), stringSize.height + verticalInsets);
...
- (CGSize)sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    finalHeight = MAX(finalHeight, _incomingAvatarViewSize.height);
