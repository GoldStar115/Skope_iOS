...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleContainerHeightConstraint;
...
- (void)awakeFromNib
{
    ...
    //Add by Nguyen Truong Luu set Corner Radius an border for avatarImageView
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    [self jsq_updateConstraint:self.messageBubbleContainerHeightConstraint
                  withConstant:customAttributes.messageBubbleContainerViewHeight];
...
- (BOOL)textView:(UITextView *)textView shouldInteractWithURL:(NSURL *)URL inRange:(NSRange)characterRange {
    ...
    //  Bug in iOS 9
    //  Dev TODO:   remove this when iOS 9 release update to fix this bug
