...
#define chatViewTintColor [UIColor colorWithRed:0.572 green:0.780 blue:0.164 alpha:1.0]//0.572,0.780,0.164
...
+ (instancetype)viewWithAttachmentIcon
{
    ...
    // Changed by Nguyen Truong Luu : change color for Send Image Button
    UIImage *paperclip = [[UIImage jsq_defaultAccessoryImage] jsq_imageMaskedWithColor:chatViewTintColor];
